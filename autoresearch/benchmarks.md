...
|------|-----|---------|-------|-----------:|--------------:|----------:|--------:|-----:|
| 2026-05-03 | A100 SXM ×1 | betelgeuse-na | pytorch/pytorch:2.4.1-cuda12.4-cudnn9-devel | 5m1s | 8m46s | 44.0 GB | 1.109645 | ~$0.015 |
...
this is what you actually pay for at $0.10/hr.
...
|------|-----|---------|----------:|-----------------:|-----:|
| 2026-05-03 | CPU only (`resourcespec-a100cpu`) | betelgeuse-na | 5m4s | ~1.0 GB (10 train shards × ~92 MB + val shard + tokenizer) | ~$0.025 |
...
($0.30/hr) is the right default — the work is single-threaded BPE training,
GPU would idle.
